...
public abstract class AbstractPlatformTransactionManager implements PlatformTransactionManager {
	 ...
	 * @throws org.springframework.transaction.CannotCreateTransactionException if transaction support is not available (e.g. no JTA UserTransaction retrievable from JNDI)
	 ...
	 * @throws IllegalTransactionStateException if suspending is not supported by the transaction manager implementation
	 * @throws TransactionException             in case of system errors
	 * @see #doResume
	 */
	 ...
	 * @throws IllegalTransactionStateException if resuming is not supported by the transaction manager implementation
	 * @throws TransactionException             in case of system errors
	 * @see #doSuspend
	 */
